...
public class DefaultEnvironmentProperties implements EnvironmentProperties {
    ...
    private final static Pattern REPLACEMENT_PATTERN = Pattern.compile("([$][$])|([$][{].*[}])|([$]\\w+)");

    public DefaultEnvironmentProperties() {
        Map<String, String> tempMap;
        try(InputStream is = DefaultEnvironmentProperties.class.getResourceAsStream("/application.properties")) {
